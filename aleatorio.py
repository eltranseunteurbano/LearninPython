...
def run():
    encontrado = False
    vida = 3
    numero_inicial = int ( raw_input ('Ingresa el número inicial: '))
    numero_final = int ( raw_input ('Ingresa el número final: '))
    ...
    while not encontrado:
        ...
        if vida <= 0:
            ...
            encontrado = True
            print("")
            denuevo = raw_input ('¿Quieres jugar de nuevo? Si - No ')
            if denuevo == 'Si':
                numero_inicial = int ( raw_input ('Ingresa el número inicial: '))
                numero_final = int ( raw_input ('Ingresa el número final: '))
                numero_random = random.randint(numero_inicial, numero_final)
